...
<section class="section-padding bg-white">
    <div class="max-w-7xl mx-auto px-6">
        ...
        $serviceData = [
            ...
            ['slug'=>'extension','title'=>'Extensions','img'=>Storage::url('portfolio/single-storey-rear-extension-1.png'),'icon'=>'M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z','desc'=>'Single storey, double storey, rear, side or wrap-around — we deliver precisely drawn extensions to satisfy planners and building control officers.','features'=>['Existing and proposed floor plans','All elevations and cross-sections','Site plan and block plan','Planning statement drawings','Building control technical package']],
