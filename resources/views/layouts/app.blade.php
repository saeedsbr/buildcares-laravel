                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="space-y-2 text-sm" style="color:#64748b;">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="https://wa.me/{{ config('contact.whatsapp_number') }}" target="_blank" rel="noopener noreferrer" class="hover:text-white transition-colors" style="color:#f8fafc;">+44 7586 750755</a>
                        </div>
                        <div class="flex items-center gap-3">
